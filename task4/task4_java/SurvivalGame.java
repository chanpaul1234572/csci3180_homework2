 ...
 * Email Addr : pchan69@cse.cuhk.edu.hk
 */
...
public class SurvivalGame {
	...
	private  void init() {
		...
		for (int i = 0; i < n / 2; i++) {
			if (i < n / 2 - 1){
				teleportObjects[i] = new Human(0, 0, i, this, 1);
				teleportObjects[i + n / 2] = new Chark(0, 0, i, this, 1);
			}
			else{
				teleportObjects[i] = new Human(0, 0, i, this, 0);
				teleportObjects[i + n / 2] = new Chark(0, 0, i, this, 0);
			}
		}
